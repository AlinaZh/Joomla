...
class __TwigTemplate_e5dce8217ddff67e9eda80bde305c155fc011a1d44c5629efbfbad0d1415d7fb extends Twig_Template
{
        ...
        <li class=\"g-menu-item g-menu-item-type-";
            ...
            ";
                ...
                if ($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "image", array())) {
                    // line 52
                    echo "                    <img src=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->urlFunc($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "image", array())));
                    echo "\" alt=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : null), "title", array()));
                    echo "\" />
                ";
...
";
    ...
    {
        return new Twig_Source("", "@particles/sidemenu.html.twig", "C:\\xampp\\htdocs\\Joomla\\templates\\jl_ifolio_free\\particles\\sidemenu.html.twig");
    }
}
